...
{}.fromkeys([num for num in range(1,20) if num%2 == 0],"even")
...
def square_each(nums_list):
    """
    Function takes in a num_list and squares each entry. Remember, you do not need to return the list!
    """
    # YOUR CODE HERE
    # for i in range(0,len(nums_list)) :
    #     nums_list.append(nums_list[0]**2)
    #     nums_list.pop(0)
    # for i in range(0,len(nums_list)) :
    #     nums_list.append(nums_list[0]**2)
    #     nums_list.reverse()
    ...
    #     nums_list.reverse()
        # print(nums_list)
    nums_list = [i*i for i in nums_list]
    print(nums_list)
